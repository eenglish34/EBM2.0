...
In order to support loading of multiple wallets in ebm-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ebm.cpp.
...
Changes to ebm.cpp
----------------------
ebm.cpp is the entry point into ebm-qt, and as such, will require some minor modifications to provide hooks for
