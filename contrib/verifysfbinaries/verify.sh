...
###   This script attempts to download the signature file SHA256SUMS.asc from ebmn.org
...
SIGNATUREFILE="https://ebmn.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://ebmn.org/bin/"
VERSIONPREFIX="ebmn-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'ebmn-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[ebmn-]<version>-[rc[0-9]] (example: ebmn-0.9.2-rc1)"
   echo "wget output:"
