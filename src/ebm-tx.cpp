...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("EblockmailCoin Core ebm-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ebm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ebm transaction") + "\n" +
                               "  ebm-tx [options] -create [commands]   " + _("Create hex-encoded ebm transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ebm transaction
