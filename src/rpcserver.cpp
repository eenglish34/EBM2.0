...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop EblockmailCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "EblockmailCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EblockmailCoin features */
        {"ebm", "masternode", &masternode, true, true, false},
        {"ebm", "listmasternodes", &listmasternodes, true, true, false},
        {"ebm", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ebm", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ebm", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ebm", "masternodedebug", &masternodedebug, true, true, false},
        {"ebm", "startmasternode", &startmasternode, true, true, false},
        {"ebm", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ebm", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ebm", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ebm", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ebm", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ebm", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ebm", "mnbudget", &mnbudget, true, true, false},
        {"ebm", "preparebudget", &preparebudget, true, true, false},
        {"ebm", "submitbudget", &submitbudget, true, true, false},
        {"ebm", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ebm", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ebm", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ebm", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ebm", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ebm", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ebm", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ebm", "checkbudgets", &checkbudgets, true, true, false},
        {"ebm", "mnsync", &mnsync, true, true, false},
        {"ebm", "spork", &spork, true, true, false},
        {"ebm", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ebm", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ebmd, or the -server option to ebm-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ebm-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3435/\n";
}
