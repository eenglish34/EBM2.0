...
/** Utility functions used by the EblockmailCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render EblockmailCoin addresses in monospace font
...
// Parse "ebm:" URI into recipient object, return true on successful parsing
