...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("EblockmailCoin Core");
	...
	QString copyrightTextBir = QChar(0xA9) + QString(tr(" 2018 The EblockmailCoin Core developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextBir);
