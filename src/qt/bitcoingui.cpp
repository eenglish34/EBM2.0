                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EblockmailCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EblockmailCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ebm: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EblockmailCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about EblockmailCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EblockmailCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EblockmailCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EblockmailCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a EblockmailCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EblockmailCoin Core help message to get a list with possible EblockmailCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EblockmailCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EblockmailCoin network", "", count));
}
...
{
    QString strTitle = tr("EblockmailCoin Core"); // default title
    ...
    // Append title to "EblockmailCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
