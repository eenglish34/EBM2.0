...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 3434;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // EblockmailCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // EblockmailCoin: 1 day
        nTargetSpacing = 1 * 60;  // EblockmailCoin: 1 minute
        nLastPOWBlock = 750;
        nMaturity = 50;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "EBM 4 Life!";
        ...
        assert(genesis.hashMerkleRoot == uint256("054bd7098229e6c9e98a53d4210840a4366a5d6922b16924045d0f58a6896938"));
        assert(hashGenesisBlock == uint256("f0f8065d6a4747c460d3107689fab28608d7f23ecf4a31bd774164c04e8d3f41"));


     // vFixedSeeds.clear();
    //    vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("137.118.248.110", "137.118.248.110"));         // Single node address
        vSeeds.push_back(CDNSSeedData("seed1.eblockmail.org", "seed1.eblockmail.org"));         // Single node address
...
public:
    CTestNetParams()
    {
        ...
        //printf("%s\n",hashGenesisBlock.ToString().c_str());
        //printf("Merkel: %s\n",genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0b9224ed634d41cf42d633119550c29a38a62132d76016b65f0c2490df45b944"));

        vFixedSeeds.clear();
        vSeeds.clear();

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet ebm addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ebm script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ebm BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ebm BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ebm BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // EblockmailCoin: 1 day
        nTargetSpacing = 1 * 60;        // EblockmailCoin: 1 minutes
        ...
        nDefaultPort = 14343;
        // printf("%s\n",hashGenesisBlock.ToString().c_str());
        assert(hashGenesisBlock == uint256("c73184c20b0b9c484328bc9fd86674b5110bc899e26aeca9c235ac885775faf7"));
