...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Eblockmail Revolutionizing Email 9/29/2018";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
  //      vSeeds.push_back(CDNSSeedData("testnet.eblockmail.org", "testnet.eblockmail.org"));         // Single node address
//        vSeeds.push_back(CDNSSeedData("testnet1.eblockmail.org", "testnet1.eblockmail.org"));       // Single node address
    //    vSeeds.push_back(CDNSSeedData("testnet2.eblockmail.org", "testnet2.eblockmail.org"));       // Single node address
