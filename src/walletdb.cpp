...
bool CWalletDB::WriteBestBlock(const CBlockLoeblockmailr& loeblockmailr)
{
    nWalletDBUpdated++;
    return Write(std::string("bestblock"), loeblockmailr);
}

bool CWalletDB::ReadBestBlock(CBlockLoeblockmailr& loeblockmailr)
{
    return Read(std::string("bestblock"), loeblockmailr);
}
