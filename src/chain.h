...
public:
    ...
    /** Return a CBlockLoeblockmailr that refers to a block in this chain (by default the tip). */
    CBlockLoeblockmailr GetLoeblockmailr(const CBlockIndex* pindex = NULL) const;
